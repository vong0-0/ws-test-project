...
import { otherNotableSitesContent, allTags } from "../../constant";
import { useEffect, useState } from "react";
import seoGenerator from "../helper/seoGenerator";

export default function OtherNotableSites() {
  ...
  const filteredPageData = otherNotableSitesContent.filter((data) => {
