...
import { modernAndContemporaryContent, allTags } from "../../constant";
import { useEffect, useState } from "react";
import seoGenerator from "../helper/seoGenerator";

export default function ModernAndContemporary() {
  ...
  useEffect(() => {
    seoGenerator(
      "Modern And Contemporary | Module C",
  ...
  const filteredPageData = modernAndContemporaryContent.filter((data) => {
