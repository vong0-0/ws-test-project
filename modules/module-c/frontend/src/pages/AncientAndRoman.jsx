...
import { ancientAndRomanContent, allTags } from "../../constant";
import { useEffect, useState } from "react";
import seoGenerator from "../helper/seoGenerator";

export default function AncientAndRoman() {
  ...
  const filteredPageData = ancientAndRomanContent.filter((data) => {
